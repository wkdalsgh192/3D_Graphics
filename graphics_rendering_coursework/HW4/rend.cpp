...
/* numParts - how many names and values */
{
	...
	*/
	...
	if (vertices[0][1] > vertices[2][1]) {
		...
		tempY = normals[0][1];
		tempZ = normals[0][2];
		normals[0][0] = normals[2][0];
		normals[0][1] = normals[2][1];
		normals[0][2] = normals[2][2];
		normals[2][0] = tempX;
		normals[2][1] = tempY;
		normals[2][2] = tempZ;
	}
	...
	vec3 RE0(vertices[1][0] - vertices[0][0], vertices[1][1] - vertices[0][1], finalIntensity[1].x - finalIntensity[0].x);
	vec3 RE1(vertices[2][0] - vertices[0][0], vertices[2][1] - vertices[0][1], finalIntensity[2].x - finalIntensity[0].x);
	vec3 GE0(vertices[1][0] - vertices[0][0], vertices[1][1] - vertices[0][1], finalIntensity[1].y - finalIntensity[0].y);
	vec3 GE1(vertices[2][0] - vertices[0][0], vertices[2][1] - vertices[0][1], finalIntensity[2].y - finalIntensity[0].y);
	vec3 BE0(vertices[1][0] - vertices[0][0], vertices[1][1] - vertices[0][1], finalIntensity[1].z - finalIntensity[0].z);
	vec3 BE1(vertices[2][0] - vertices[0][0], vertices[2][1] - vertices[0][1], finalIntensity[2].z - finalIntensity[0].z);

	// Define vertices for each color plane
	vec3 redVertex(vertices[0][0], vertices[0][1], finalIntensity[0].x);
	vec3 greenVertex(vertices[0][0], vertices[0][1], finalIntensity[0].y);
	vec3 blueVertex(vertices[0][0], vertices[0][1], finalIntensity[0].z);
