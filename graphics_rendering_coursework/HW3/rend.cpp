...
int GzRender::GzDefault()
{
	...
	GzPixel defaultPixel = { 2055, 1798, 1541, 1, MAXINT };
...
int GzRender::GzPutCamera(GzCamera camera)
{
	...
	*/
	...
	memcpy(m_camera.Xiw, camera.Xiw, sizeof(GzMatrix));
	memcpy(m_camera.Xpi, camera.Xpi, sizeof(GzMatrix));
	...
	m_camera.FOV = camera.FOV; /* degrees */
